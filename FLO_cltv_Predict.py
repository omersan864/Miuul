...
def replace_with_treshold(dataframe, variable):
    low_limit, up_limit = outlier_treshold(dataframe, variable)
...
treshold_columns = ["order_num_total_ever_online",
                    "order_num_total_ever_offline",
                    "customer_value_total_ever_offline",
                    "customer_value_total_ever_online"]

for col in treshold_columns:
...
analysis_date = dt.datetime(year=2021, month=6, day=1)
