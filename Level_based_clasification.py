...
df = pd.read_csv('Numpy-Pandas_Learn/datasets/persona.csv')
df.head()

def check_df(dataframe, head=5, corr=False):
    print("##################### Shape #####################")
...
agg_df = agg_df.drop("NEW_AGE", axis=1, inplace=True)
